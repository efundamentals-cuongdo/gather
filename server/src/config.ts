...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'gather';
    ...
    'jhipster.mail.from' = 'gather@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'gather API';
    'jhipster.swagger.description' = 'gather API documentation';
    ...
    'eureka.instance.appname' = 'gather';
    'eureka.instance.instanceId' = 'gather:${random.value}';
